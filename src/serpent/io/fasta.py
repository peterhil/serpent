...
from serpent.io.printing import err, info
...
def regex_match(reg, descriptions):
	"""Allow filtering sequences by regexp option on commands."""
	return reg is None or re.search(reg, str_join(descriptions)) is not None
